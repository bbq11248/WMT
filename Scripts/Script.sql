...
CREATE TABLE SEATMANAGER( -- 좌석 관리
	SEAT_NO VARCHAR2(7),
	SEAT VARCHAR2(100) NOT NULL, -- 좌석PK
...
/*CREATE TABLE SEATPRICE( -- 좌석 가격
   PRICE_NO VARCHAR2(7) NOT NULL, -- 가격 번호PK
   SEAT_MONEY NUMBER -- 좌석 가격
);*/
...
ALTER TABLE TICKETING ADD CONSTRAINT TICKETING1_FK FOREIGN KEY (MOVIE_THEATER_NO) REFERENCES MOVIE_THEATER (MOVIE_THEATER_NO);

-- 상영관
ALTER TABLE MOVIE_THEATER ADD CONSTRAINT MOVIE_THEATER_FK FOREIGN KEY (THEATER_NO) REFERENCES THEATER (THEATER_NO);
ALTER TABLE MOVIE_THEATER ADD CONSTRAINT MOVIE_THEATER1_FK FOREIGN KEY (MOVIE_NO) REFERENCES MOVIE (MOVIE_NO);
...
/*
ALTER TABLE SEATMANAGER ADD CONSTRAINT SEATMANAGER1_FK FOREIGN KEY (PRICE_NO) REFERENCES SEATPRICE (PRICE_NO);
*/
...
ALTER TABLE PAYMENT ADD CONSTRAINT PAYMENT_FK FOREIGN KEY (TICKETING_NO) REFERENCES TICKETING (TICKETING_NO);
ALTER TABLE PAYMENT ADD CONSTRAINT PAYMENT_FK2 FOREIGN KEY (ID) REFERENCES MOVIEMEMBER (ID);
...
DROP SEQUENCE MILEAGEMANAGER_SEQ;
DROP SEQUENCE PAYMENT_SEQ;
DROP SEQUENCE SEATMANAGER_SEQ;
